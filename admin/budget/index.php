						...
						<tr>
							...
							<td align="center">
								 <!--<button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
								  ...
								  <a><i class="manage_budget" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span></i></a>
 								  <a><i class="delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-category_id="<?php echo $row['category_id'] ?>"><span style="text-indent: 10px;" class="fa fa-trash text-danger"></span></i></a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
