...
<form action="" id="expense-form">
    ...
    <div class="form-group">
        <input type="hidden" class="form-control" placeholder="Enter type" readonly name="type" value="Expense" required >
    </div>
    <!---Type end----->
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" class="form-control" name="date_created" value="<?= date('Y-m-d h:i'); ?>" required>
    </div>
    <!---Dated created end----->
    <div class="form-group">
    ...
    <!---Date Release start----->
    <div class="form-group">
        <label for="daterelease" class="control-label">Date Released</label>
        <input type="datetime-local" class="form-control" name="daterelease" value="<?= date('Y-m-d h:i'); ?>" required>
    </div>
    <!---Date Release end----->
    <div class="form-group">
