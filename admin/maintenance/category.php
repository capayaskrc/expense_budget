						...
						<tr>
							...
							<td align="center">
								 <!--<button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
								  ...
								  <a href="?page=maintenance/manage_category&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span></a>
				                    
				                  <a class="delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span style="text-indent: 10px;" class="fa fa-trash text-danger"></span></a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
